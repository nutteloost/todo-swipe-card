        ...
        <div class="section">
          ...
          <div class="card-list">
            ${0===i.length?W`<div class="no-cards">
                ...
                </div>`:i.map((t,e)=>{const o=this.Hi(t),n=this.ui.has(e),s=this.Ki(e);return W`
                    <div
