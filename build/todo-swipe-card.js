...
`}
    ...
    `}}customElements.define("todo-swipe-card",TodoSwipeCard),customElements.define("todo-swipe-card-editor",TodoSwipeCardEditor),window.customCards||(window.customCards=[]),window.customCards.some(t=>"todo-swipe-card"===t.type)||window.customCards.push({type:"todo-swipe-card",name:"Todo Swipe Card",preview:!0,description:"A specialized swipe card for to-do lists"}),console.info(`%c TODO-SWIPE-CARD %c v${t} %c - A swipeable card for to-do lists`,"color: white; background: #4caf50; font-weight: 700;","color: #4caf50; background: white; font-weight: 700;","color: grey; background: white; font-weight: 400;");var Ot=/*#__PURE__*/Object.freeze({__proto__:null,setupDragAndDrop:function(t,i,e,o){const n=t.querySelectorAll('.todo-item[data-supports-drag="true"]');let s=null,r=null;n.forEach((a,d)=>{const c=e[d];c&&(a.setAttribute("draggable","true"),a.addEventListener("dragstart",t=>{if(t.target.closest("ha-checkbox")||t.target.closest(".todo-checkbox"))return void t.preventDefault();a.classList.add("dragging"),t.dataTransfer.effectAllowed="move",t.dataTransfer.setData("text/plain",c.uid);const i=document.createElement("div");i.style.cssText="position: absolute; top: -1000px; width: 1px; height: 1px; opacity: 0;",document.body.appendChild(i),t.dataTransfer.setDragImage(i,0,0),setTimeout(()=>{document.body.removeChild(i)},0),c.summary}),a.addEventListener("dragend",()=>{a.classList.remove("dragging"),n.forEach(t=>t.classList.remove("drag-over-top","drag-over-bottom")),s=null,r=null,c.summary}),a.addEventListener("dragover",i=>{i.preventDefault(),i.dataTransfer.dropEffect="move";const e=t.querySelector(".dragging");if(!e||e===a)return void(s&&(s.classList.remove("drag-over-top","drag-over-bottom"),s=null,r=null));const o=a.getBoundingClientRect(),d=o.top+o.height/2,c=i.clientY<d?"top":"bottom";s===a&&r===c||(n.forEach(t=>t.classList.remove("drag-over-top","drag-over-bottom")),"top"===c?a.classList.add("drag-over-top"):a.classList.add("drag-over-bottom"),s=a,r=c)}),a.addEventListener("drop",async d=>{d.preventDefault(),d.stopPropagation();const h=t.querySelector(".dragging");if(!h||h===a)return n.forEach(t=>t.classList.remove("drag-over-top","drag-over-bottom")),s=null,void(r=null);const l=d.dataTransfer.getData("text/plain"),p=e.find(t=>t.uid===l);if(!p)return n.forEach(t=>t.classList.remove("drag-over-top","drag-over-bottom")),s=null,void(r=null);const u=a.getBoundingClientRect(),g=u.top+u.height/2,m=d.clientY<g;let f=null;if(m){const t=e.findIndex(t=>t.uid===c.uid);t>0&&(f=e[t-1].uid)}else f=c.uid;const v=e.findIndex(t=>t.uid===l),b=e.findIndex(t=>t.uid===c.uid);if(m&&b===v+1)return n.forEach(t=>t.classList.remove("drag-over-top","drag-over-bottom")),s=null,void(r=null);if(!m&&b===v-1)return n.forEach(t=>t.classList.remove("drag-over-top","drag-over-bottom")),s=null,void(r=null);n.forEach(t=>t.classList.remove("drag-over-top","drag-over-bottom")),s=null,r=null,p.summary;const{moveItem:w}=await Promise.resolve().then(function(){return At});await w(i,l,f,o)}))})}});export{TodoSwipeCard,TodoSwipeCardEditor};
