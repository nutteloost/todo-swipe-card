...
`}
    `}Ve(t,e){if(!this.kt?.entities)return;const i=[...this.kt.entities],o=t+e;if(o<0||o>=i.length)return;[i[t],i[o]]=[i[o],i[t]],this.ve.has(t)&&(this.ve.delete(t),this.ve.add(o)),this.ve.has(o)&&(this.ve.delete(o),this.ve.add(t));const n={...this.kt,entities:i};this.kt=n,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n}})),this.requestUpdate()}Fe(t){this.ve.has(t)?this.ve.delete(t):(this.ve.clear(),this.ve.add(t)),this.requestUpdate()}Re(t){this.be=t,this.requestUpdate(),setTimeout(()=>{this.be="normal",this.requestUpdate()},"blocked"===t?1e3:500)}Ue(t=-1){if(!this.hass)return[];const e=Object.keys(this.hass.states).filter(t=>t.startsWith("todo.")&&this.hass.states[t]),i=(this.kt.entities||[]).map((e,i)=>i===t?null:this.Tt(e)).filter(t=>t&&""!==t.trim());return e.filter(t=>!i.includes(t))}Je(t){const e=this.Tt(t);if(!e||""===e.trim())return{displayName:"Empty Entity",friendlyName:""};const i=this.hass?.states?.[e],o=i?.attributes?.friendly_name||e.split(".").pop().replace(/_/g," ");return{displayName:o,friendlyName:o}}Be(t){if(!this.kt||!this.hass)return;const e=t.target,i=void 0!==e.checked?e.checked:e.value,o=e.configValue||e.getAttribute("data-config-value");if(o){const t=this._e({...this.kt,[o]:i});this.kt=t,this.Ze(t)}}Ze(t){this.qe&&clearTimeout(this.qe),this.qe=setTimeout(()=>{const e=this._e(t);this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e}}))},150)}We(t){if(!this.kt)return;const e=parseInt(t.target.value);if(!isNaN(e)&&e>=0){const t=this._e({...this.kt,card_spacing:e});this.kt=t,this.Ze(t)}}Xe(t){if(!this.kt)return;const e=parseInt(t.target.value);if(!isNaN(e)&&e>=1){const t=this._e({...this.kt,font_size:e});this.kt=t,this.Ze(t)}}Ke(t){if(!this.kt)return;const e=parseInt(t.target.value);if(!isNaN(e)&&e>=1){const t=this._e({...this.kt,title_font_size:e});this.kt=t,this.Ze(t)}}we(t){if(t&&(t.preventDefault(),t.stopPropagation()),!this.kt)return;const e=Array.isArray(this.kt.entities)?[...this.kt.entities]:[];if(e.length>0&&(""===e[e.length-1]||"object"==typeof e[e.length-1]&&""===e[e.length-1].entity))return void this.Re("blocked");e.push({entity:""});const i={...this.kt,entities:e};this.kt=i,this.Re("success"),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0})),setTimeout(()=>{this.requestUpdate()},0)}Ge(t){if(!this.kt||!Array.isArray(this.kt.entities))return;const e=[...this.kt.entities];e.splice(t,1),this.ve.delete(t);const i=new Set;this.ve.forEach(e=>{e>t?i.add(e-1):e<t&&i.add(e)}),this.ve=i;const o={...this.kt,entities:e};this.kt=o,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o}})),this.requestUpdate()}Ye(t){const e=parseInt(t.target.getAttribute("data-index"));if(isNaN(e))return;const i=t.detail?.value||t.target.value||"",o=[...this.kt.entities],n=o[e];o[e]="object"==typeof n?{...n,entity:i}:{entity:i};const r={...this.kt,entities:o};this.kt=r,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:r}})),this.requestUpdate()}Qe(t){const e=parseInt(t.target.getAttribute("data-index"));if(isNaN(e))return;const i=(t.detail?.value??t.target.value)||"none",o=[...this.kt.entities],n=o[e];o[e]="string"==typeof n?{entity:n,display_order:i}:{...n,display_order:i};const r={...this.kt,entities:o};this.kt=r,this.Ze(r)}ti(t){const e=parseInt(t.target.getAttribute("data-index"));if(isNaN(e))return;const i=t.target.value||"",o=[...this.kt.entities],n=o[e];if("string"==typeof n){const t={entity:n};i&&(t.background_image=i),o[e]=t}else if(i)o[e]={...n,background_image:i};else{const t={...n};delete t.background_image,o[e]=t}const r={...this.kt,entities:o};this.kt=r,this.Ze(r)}ei(t){const e=parseInt(t.target.getAttribute("data-index"));if(isNaN(e))return;const i=t.target.checked,o=[...this.kt.entities],n=o[e];o[e]="string"==typeof n?{entity:n,show_title:i}:{...n,show_title:i};const r={...this.kt,entities:o};this.kt=r,this.Ze(r)}ii(t){const e=parseInt(t.target.getAttribute("data-index"));if(isNaN(e))return;const i=t.target.value||"",o=[...this.kt.entities],n=o[e];if("string"==typeof n){const t={entity:n};i&&(t.title=i),o[e]=t}else if(i)o[e]={...n,title:i};else{const t={...n};delete t.title,o[e]=t}const r={...this.kt,entities:o};this.kt=r,this.Ze(r)}oi(t){const e=parseInt(t.target.getAttribute("data-index"));if(isNaN(e))return;const i=t.target.value||"",o=[...this.kt.entities],n=o[e];if("string"==typeof n){const t={entity:n};i&&(t.icon=i),o[e]=t}else if(i)o[e]={...n,icon:i};else{const t={...n};delete t.icon,o[e]=t}const r={...this.kt,entities:o};this.kt=r,this.Ze(r)}ni(t){const e=parseInt(t.target.getAttribute("data-index"));if(isNaN(e))return;const i=t.target.checked,o=[...this.kt.entities],n=o[e];if("string"==typeof n)i&&(o[e]={entity:n,hide_future_items:!0});else if(i)o[e]={...n,hide_future_items:!0};else{const t={...n};delete t.hide_future_items,o[e]=t}const r={...this.kt,entities:o};this.kt=r,this.Ze(r)}ri(t){const e=parseInt(t.target.getAttribute("data-index"));if(isNaN(e))return;const i=parseInt(t.target.value),o=[...this.kt.entities],n=o[e];if("string"==typeof n)!isNaN(i)&&i>=1&&(o[e]={entity:n,max_items:i});else if(!isNaN(i)&&i>=1)o[e]={...n,max_items:i};else{const t={...n};delete t.max_items,o[e]=t}const r={...this.kt,entities:o};this.kt=r,this.Ze(r)}si(t){const e=this.kt.entities[t];return"string"==typeof e?{entity:e,display_order:"none",show_title:!1,title:"",background_image:"",hide_future_items:!1,max_items:void 0}:{entity:e?.entity||"",display_order:e?.display_order||"none",show_title:e?.show_title||!1,title:e?.title||"",background_image:e?.background_image||"",icon:e?.icon||"",hide_future_items:e?.hide_future_items||!1,max_items:e?.max_items||void 0}}ai(){return[{value:e,label:"Default"},{value:i,label:"Alphabetical A-Z"},{value:o,label:"Alphabetical Z-A"},{value:n,label:"Due Date (Earliest First)"},{value:r,label:"Due Date (Latest First)"}]}di(t,e){t.stopPropagation(),this.Fe(e)}ci(t,e){t.stopPropagation(),e()}li(t,e){"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),t.stopPropagation(),this.Fe(e))}hi(t){t.stopPropagation(),t.preventDefault()}render(){if(!this.hass||!this.kt)return W`<div>Loading...</div>`;const e=Array.isArray(this.kt.entities)?this.kt.entities:[];return JSON.stringify(this.kt),W`
