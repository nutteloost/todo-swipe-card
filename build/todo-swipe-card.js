        ...
        <div class="section">
          ...
          <div class="card-list">
            ${0===i.length?W`<div class="no-cards">
                  No todo lists added yet. Click "+ ADD TODO LIST" below to add your first list.
                </div>`:i.map((t,e)=>{const o=this.Hi(t),n=this.ui.has(e),s=this.Yi(e);return W`
                    <div
                    ...
                    >
                      ...
                      <div class="card-actions" @click=${this.oe}>
                        <ha-icon-button
                          label="Move Up"
                          ?disabled=${0===e}
                          path="M7,15L12,10L17,15H7Z"
                          @click=${t=>this.ie(t,()=>this.Oi(e,-1))}
                        ></ha-icon-button>
                        <ha-icon-button
                          label="Move Down"
